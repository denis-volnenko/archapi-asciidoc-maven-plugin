package ru.volnenko.plugin.arch.api.archapi.model.archapi;

import com.fasterxml.jackson.annotation.JsonIgnoreProperties;
import lombok.Getter;
import lombok.NoArgsConstructor;
import lombok.Setter;
import ru.volnenko.plugin.arch.api.archapi.model.archapi.impl.*;
import ru.volnenko.plugin.arch.api.archapi.model.archapi.impl.ContextView;
import ru.volnenko.plugin.arch.api.archapi.model.archapi.impl.LogicView;
import ru.volnenko.plugin.arch.api.archapi.model.archapi.impl.PhysicView;
import ru.volnenko.plugin.arch.api.archapi.model.archapi.impl.SecurityView;
