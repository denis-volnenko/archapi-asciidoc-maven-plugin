package ru.volnenko.plugin.arch.archapi.builder.dataapi.impl;

import lombok.NonNull;
import ru.volnenko.plugin.arch.archapi.builder.dataapi.IColumnBuilder;
import ru.volnenko.plugin.arch.archapi.builder.dataapi.IDataApiBuilder;
import ru.volnenko.plugin.arch.archapi.builder.dataapi.IEntityBuilder;
import ru.volnenko.plugin.arch.archapi.builder.dataapi.ITableBuilder;
